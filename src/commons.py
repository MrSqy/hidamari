...
CONFIG_KEY_PLAYLIST_DEFAULT_INTERVAL_SEC = "playlist_default_interval_sec"
CONFIG_KEY_PLAYLIST_INTERVAL_OVERRIDES = "playlist_interval_overrides"
...
CONFIG_TEMPLATE = {
    ...
    CONFIG_KEY_PLAYLIST_DEFAULT_INTERVAL_SEC: 30,
    CONFIG_KEY_PLAYLIST_INTERVAL_OVERRIDES: {},
}
